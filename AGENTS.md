...
- Logging architecture notes live under `docs/日志系统/`; `日志系统架构.md` describes the current implementation, and `新增功能-输出日志到文件-正式设计.md` is the frozen file-logging design.
